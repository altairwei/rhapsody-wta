...
yhatSmoothDf <- tradeSeq::predictSmooth(
  tradeSce_chl_cond, rownames(tradeSce_chl_cond), nPoints = 100, tidy = FALSE)
...
openxlsx::saveWorkbook(
  wb, file = "../results/DataPlots/SupplementaryTable_X_traj_chlorenchyma_pseudotime_expr.xlsx",
  overwrite = TRUE)
```
