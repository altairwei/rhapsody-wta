...
patchwork::wrap_plots(
  plot_cell_score(PNR2_da, "tsne", label = TRUE, label_cols = ident_cols) +
    ggplot2::coord_fixed() +
    ggplot2::ggtitle("PNR2 vs. MOCK"),
  plot_cell_score(TR4_da, "tsne", label = TRUE, label_cols = ident_cols) +
    ggplot2::coord_fixed() +
...
```{r fig.height=7, fig.width=15}
patchwork::wrap_plots(
  plot_cell_score(PNR2_da, "umap", label = TRUE, label_cols = ident_cols) +
    ggplot2::coord_fixed() +
    ggplot2::ggtitle("PNR2 vs. MOCK"),
  plot_cell_score(TR4_da, "umap", label = TRUE, label_cols = ident_cols) +
    ggplot2::coord_fixed() +
    ggplot2::ggtitle("TR4 vs. MOCK")
)
```
