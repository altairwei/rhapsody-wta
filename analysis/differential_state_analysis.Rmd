...
```{r show-dim-plot, warning=FALSE, echo=FALSE}
Seurat::DimPlot(obj, reduction = "tsne", group.by = "group") + ggplot2::theme(plot.title = ggplot2::element_blank())
Seurat::DimPlot(obj, reduction = "tsne", label = TRUE, repel = TRUE, cols = ident_cols)
Seurat::DimPlot(obj, reduction = "umap", label = TRUE, repel = TRUE, cols = ident_cols)
```
