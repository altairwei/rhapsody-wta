...
p2 <- Seurat::DotPlot(obj_mock, features = markers) +
  ggplot2::coord_flip() +
  ggplot2::facet_grid(
...
```{r}
gointeractive(gsea, showCategory = 100, color = "NES")
```
...
p <- Seurat::DotPlot(obj, features = markers) +
  ggplot2::coord_flip() +
  ggplot2::facet_grid(
    facets = feature.groups ~ .,
    scales = "free_y",
...
scater::plotExpression(sce_pal, PAL_pathways, x = "cluster_id", exprs_values = "activity", ncol = 1)
```
