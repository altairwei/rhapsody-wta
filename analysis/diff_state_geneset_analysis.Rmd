...
comp_enr@compareClusterResult$cluster <- factor(
  comp_enr@compareClusterResult$cluster, c("VCs_5", "MCs_5", "MCs_1"))
enrichplot::dotplot(
    comp_enr, x = "contrast",
...
gsea1 <- performDSEnrichGSEA(ds_res$DESeq2, "X1DPI.PNR2-X1DPI.MOCK", "MCs_5", ont = "BP")
gsea2 <- performDSEnrichGSEA(ds_res$DESeq2, "X1DPI.PNR2-X1DPI.MOCK", "MCs_5", ont = "MF")
```
...
comp_enr@compareClusterResult$cluster <- factor(
  comp_enr@compareClusterResult$cluster, c("VCs_5", "MCs_5", "Un_1"))
```
