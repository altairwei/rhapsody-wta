...
p1 <- Seurat::DimPlot(obj, reduction = "tsne", group.by = "group") +
  ggplot2::theme(plot.title = ggplot2::element_blank())

p2 <- Seurat::DimPlot(obj, reduction = "pca", group.by = "group") +
  ggplot2::theme(plot.title = ggplot2::element_blank())
...
```{r fig.height=4, fig.width=9}
p1 <- Seurat::DimPlot(obj_merged, reduction = "tsne", group.by = "group") +
  ggplot2::theme(plot.title = ggplot2::element_blank())

p2 <- Seurat::DimPlot(obj_merged, reduction = "pca", group.by = "group") +
  ggplot2::theme(plot.title = ggplot2::element_blank())
